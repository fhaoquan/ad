...
(function() {
    ...
    qq.FineUploaderBasic = function(o) {
        ...
        this._options = {
            ...
            messages: {
                typeError: "{file} 禁止上传此格式文件，可以上传的格式: {extensions}.",
                sizeError: "{file} 文件超出限制大小，最大上传限制 {sizeLimit}.",
                minSizeError: "{file} 文件太小，最小上传限制 {minSizeLimit}.",
                emptyError: "{file} 文件内容为空，请重新选择",
                noFilesError: "没有可以上传的文件.",
                tooManyItemsError: "无法上传{netItems}个文件，限制上传{itemLimit}个文件",
                maxHeightImageError: "图片高度超出限制",
                maxWidthImageError: "图片宽度超出限制",
                minHeightImageError: "图片高度未达到最小高度",
                minWidthImageError: "图片宽度未达到最小宽度",
                retryFailTooManyItems: "重试失败 - 你已经达到文件限制.",
            ...
            text: {
                defaultResponseError: "上传失败，原因未知",
